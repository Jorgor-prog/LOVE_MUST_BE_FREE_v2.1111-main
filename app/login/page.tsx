    ...
    <div className="bg-hero center-wrap">
      ...
      <div className="form-layer">
        <form onSubmit={submit} className="form-card">
          ...
          <input className="input" placeholder="Your login" value={login} onChange={e=>setLogin(e.target.value)} autoComplete="username" autoCapitalize="off" spellCheck={false}/>
          <div className="label">Your password</div>
          <input className="input" placeholder="Your password" type="password" value={password} onChange={e=>setPassword(e.target.value)} autoComplete="current-password"/>
